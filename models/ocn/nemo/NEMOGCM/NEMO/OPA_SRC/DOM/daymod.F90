MODULE daymod
   ...
   !! $Id: daymod.F90 2715 2011-03-30 15:58:35Z rblod $
...
!        mm = ss/60
!        ss = MOD(ss,60)
!        WRITE(numout,FMT='(A,i8,A,i4.4,A,i2.2,A,i2.2,A,i2.2,A,i2.2,Ai2.2)') &
!        'day(): DATE-TIME: kt=', kt, ' Y/M/D=', nyear,'/',nmonth,'/',nday, ' H/M/S=', &
!        hh, '/', mm, '/', ss
!        CALL flush(numout)
!      END IF
